...
function onUse(cid, item, fromPosition, itemEx, toPosition)
	...
	if item.itemid == 5791 and getPlayerVocation(cid) == 3 then
	...
	if item.itemid == 5791 and getPlayerVocation(cid) == 1 or getPlayerVocation(cid) == 2 then
		if getPlayerStorageValue(cid,storage) <= 0 then
			setPlayerStorageValue(cid, 8080, 80)
			doPlayerAddExperience(cid, getExperienceForLevel(80))
			setPlayerPromotionLevel(cid, 1)
	...
	if item.itemid == 5791 and getPlayerVocation(cid) == 4 then
		if getPlayerStorageValue(cid,storage) <= 0 then
			setPlayerStorageValue(cid, 8080, 80)
			doPlayerAddExperience(cid, getExperienceForLevel(80))
			setPlayerPromotionLevel(cid, 1)
