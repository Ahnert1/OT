...
local function onError(protocol, message, errorCode)
  ...
  local errorBox = displayErrorBox(tr('Oops!'), message .. ' Please use 1/1 or 2/2 to start pvping now! \nMore info on how to get your own account at ChaosWar.servegame.com!')
